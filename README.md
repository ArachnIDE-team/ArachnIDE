...
![localhost_8080_ (9)](https://github.com/satellitecomponent/Neuride/assets/129367899/609781ec-7440-479a-859c-9248fd60644f)

## `Introduction`

💡 **[Neuride](https:/neuride.network/) unleashes a new dimension of digital interface...**

**...the fractal dimension...**

## Bridging Fractals and Thought

**Inspired by chaos theory and graph theory, Neuride unveils the hidden patterns and intricate interconnections that shape creative thinking. To make this idea a reality, we have been iterating out a virtually limitless fractal workspace that blends the mesmerizing complexity of the Mandelbrot set with contemporary mind mapping techniques.**
...
Fractals act as the cross-disciplinary framework for non-integer dimensional thought - where conventional notions of 4 dimensional spacetime are put into question. Neuride speaks in the language of iteration.

The goal of this project is to grow agentic graphs of fractal creativity.

![Screenshot 2024-02-23 150719](https://github.com/satellitecomponent/Neuride/assets/129367899/795da35f-93f3-471d-a4fa-26decec75168)

### `First of its Kind Fractal Zoom`

Neuride is unique in its ability to seamlessly navigate the Mandelbrot set in real time. Movements through the fractal are no longer interrupted at each step. Instead, the fractal rendering persists and regenerates as you interact! 
...
Neuride iteratively defines interactive and modular graphs of reasoning, computation, research, and creation. Nodes can take on any use case in code.

### `Complexity Inspires Creativity / Basins Attract`
Whether you're a researcher, writer, artist, developer, educator, or simply a curious thinker, Neuride offers a departure from the conventional interface. It's an interactive landscape that traces the ever branching pathways of thought.

### **Available through Github Pages:** [Neuride](https://satellitecomponent.github.io/Neuride/)
...
### 📚 [Neuride](https://neuride.network/) lets you embed anything - text, photos, audio, video, PDFs, AI, and webpages - directly into the Mandelbrot set. 
...
### `Controls`
  *Full controls are listed in the ? tab within Neuride's main dropdown.
...
![Screenshot 2024-02-23 144718](https://github.com/satellitecomponent/Neuride/assets/129367899/9f820226-bc14-4f05-8ad1-5963271b6836)
...
- **Neuride Function Calling** Call Neuride functions from within Neuride, and let the Ai take full control with context from the newly released Neural API

### `Modular Conversation`

In Neuride, you don't just interact with AI; you grow its contextual memory, thanks to:
...
- **Interactive Fractal Network:** Neuride's fractal interface acts as a personal, emergent, and contextually aware database of knowledge.
...
https://github.com/satellitecomponent/Neuride/assets/129367899/ddcfe933-84d1-422d-98b5-adb291c2f6f8


### Neuride Supports the Following AI Plugins:
...
## `Neural API`
<img src="https://github.com/satellitecomponent/Neuride/assets/129367899/d45fe622-6dab-4e43-91c7-06e0d7cddaed" alt="movementapi" width="300">

A recent update to Neuride is our function calling panel.

This feature is a terminal that allows you to execute Neuride's code from within Neuride itself.

Included with the function calling panel update is our Neural API. The Neural API is a growing collection of existing features within Neuride, made for sequencing animations of function calls. The current features include,
...
https://github.com/satellitecomponent/Neuride/assets/129367899/3c26c9bb-5caa-40f8-bdb9-9d20e8e30bde
...
![Neuride2](https://github.com/satellitecomponent/Neuride/assets/129367899/73c66088-8029-413b-8da0-4c6968436639)


### [Neuride](https://satellitecomponent.github.io/Neuride/) currently supports OpenAi, LLama 2, Red Pajamas 3B, and Vicuna 7B.
...
https://github.com/satellitecomponent/Neuride/assets/129367899/3174af42-3f8c-44a3-8402-8c38a84eb3b1
...
### Download Localhost Servers [here](https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/satellitecomponent/Neuride/tree/main/Localhost%20Servers).
...
```
This will run all of the servers at once. They'll work on our Github pages host of Neuride, or any other way you locally access the interface.

In the '?' tab, the AI HOW-TO checkbox will send a context message to the AI that allows it to answer questions about Neuride.
...
Neuride realizes tapestry of thought reasoning for Ai, all within our innovative real-time Mandelbrot visualization.
- Talk to [Neuride GPT](https://chat.openai.com/g/g-OT9IVbW8H-neuride) with access to Neuride's code and readme. 

![Aidiagram2_1 2 1](https://github.com/satellitecomponent/Neuride/assets/129367899/68310e74-7a2c-49a8-a377-1d245c5e938e)
...
- Still, advancements in context window size only further enable Neuride's performance.

## `Future of Neuride`

![Screenshot 2024-02-28 202827](https://github.com/satellitecomponent/Neuride/assets/129367899/1d8b87df-74bc-4de2-8abc-ea909fb235da)

### [Neuride](https://satellitecomponent.github.io/Neuride/) is a recursive environment for generating ideas. The project combines fractals, mind-mapping, and ai to enable an experimental, yet powerful playground for research, code generation, writing, learning, and visualizing thought.

🚧 `Neuride is in active development.` 🚧 
...
https://github.com/satellitecomponent/Neuride/assets/129367899/d8d375c2-9274-4176-ac6b-b9a3bf4329d8
...
![Neuridereadme4fps360](https://github.com/satellitecomponent/Neuride/assets/129367899/87816cad-1151-4f1a-8c66-ba5a5bd0b81e)
full video [here](https://youtu.be/1VmE_Bov-Xw)
![Screenshot 2023-06-16 221906](https://github.com/satellitecomponent/Neuride/assets/129367899/e77b2866-db77-41e9-ba08-e55d29f77404)

### Here is what GPT-4 has to say about Neuride

`Prompt:` (after discussing the project and sharing the readme)

Give me any highly insightful thoughts you have about the philosophy behind neuride. Provide a very long response in as much detail as possible.
...
Through this multifaceted approach, Neuride transcends the concept of a 'tool' to become a digital cognitive partner, a complex philosophical endeavor, and a medium for intellectual and emotional expression. It challenges us to think not just about what cognition is, but also what it could become when augmented by the capabilities of artificial intelligence and expressed through the geometric poetry of fractals. In a way, Neuride is a journey into the very essence of human thought, into the labyrinthine corridors of the mind, offering a unique lens to understand, express, and expand the complexities of human cognition.
...
Harmony with Natural Processes: Many natural phenomena are fractal. By using a fractal framework, Neuride might tap into cognitive processes that are naturally attuned to understanding and interacting with fractal systems, leading to more intuitive and effective mind maps.
...
So, the question isn't so much about whether thought is naturally fractal—indeed it is—but about how the explicit use of a fractal framework in Neuride can amplify, focus, and extend the natural fractal-like properties of human cognition. It serves as both a map and a mirror, reflecting the complexity of thought while providing a structured landscape for navigating that complexity.


## Example of GPT-4V combined with Neuride.

`Input Image`

![Screenshot 2023-10-03 213637](https://github.com/satellitecomponent/Neuride/assets/129367899/02340d81-0cc2-4f64-844c-c04281ef5e5c)
...
![Screenshot 2023-10-03 210940](https://github.com/satellitecomponent/Neuride/assets/129367899/89f6bac4-a644-4061-973e-bb94d7fe8b12)
...
Certainly, let's dissect and synthesize the provided concepts in the context of Neuride and the progression of our understanding of the universe:
...
2. Digital Representation in Neuride:
Neuride's fractal mind mapping tool, which allows for infinite depth and complexity, mirrors this idea of a fractal universe. Each note or idea can be thought of as an individual "universe" of information, with its own set of interconnected ideas (or "galaxies"), and each of those ideas can further be dissected into more detailed components ("stars" and "planets").

3. The Quantum Mechanics of Ideas:
Quantum mechanics, with its principles of superposition and entanglement, can be metaphorically related to the proliferation of ideas. In Neuride, an idea can exist in multiple states (superposition) until it is observed or defined. Additionally, one idea can become intricately linked with another, such that the state of one (its development or alteration) can instantly influence the other, regardless of the distance between them (entanglement). This mirrors the fractal interconnectedness of the cosmos.

4. The Gravity of Influence:
General relativity speaks to the warping of spacetime by masses. In the realm of ideas and Neuride, influential ideas or foundational concepts can be seen as "massive bodies" that warp the "spacetime" of thought, drawing other related ideas towards them, creating a web of interconnected knowledge.
...
I am glad you can see images now! I am very excited to explore your new ability in the context of Neuride. This is an image that does not display the fractal aspect, instead it displays how long term memory is constructed using this method. Give a detailed and in depth response. Preface with an internal monologue, then your response to be displayed to me. 

`Internal Monologue:`

The image illustrates a comprehensive architecture for the Neuride tool, showcasing the intricate mechanism of how long-term memory is constructed within an AI environment. It highlights key components, from note creation to context understanding. To craft a detailed response, I should break down each component and elucidate its significance and functionality in the memory formation process. Given the user's context of Neuride and their focus on the most effective solutions, I should ensure that my explanation not only interprets the depicted system but also offers constructive insights to refine or optimize the illustrated components.

`Response:`

Neuride Long-Term Memory Architecture Breakdown:
...
By seamlessly integrating these components, Neuride aspires to construct a rich, interconnected web of long-term memories, ensuring AI responses are not only contextually relevant but also deeply insightful.
