...
let chrysalIDENode = createProjectNode("ChrysalIDE", "../..")
chrysalIDENode.pos = rootDiagram.background.pan;
chrysalIDENode.followingMouse = 0;

let chrysalIDEFrontend = createJavascriptFrontendModuleNode("Frontend", [], "../..",  ["js/**/**.js", "**/**.html"],["dist/**", "Localhost Servers/**", "Automation/**", "**/node_modules/**"])
...
textNode = createNodeFromWindow(null, "simple text", true)
